    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/noahssark" />
                <IconBtn icon={Instagram} m={1} href="https://www.instagram.com/awopejunoah/" />
                <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/noah-oladele-16b4b1123/" />
                <IconBtn icon={Email} m={1} href="mailto:awopejunoah1@gmail.com" />
            </div>
        );
    } else {
        return (
